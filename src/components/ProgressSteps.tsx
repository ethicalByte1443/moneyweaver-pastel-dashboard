...
export function ProgressSteps() {
  return (
    <div className="mb-8">
      <div className="mb-4">
        <h2 className="text-xl font-medium text-gray-900 mb-1">Well begun is half done</h2>
        <p className="text-sm text-gray-500">Complete the following steps to sell</p>
      </div>
      
      <div className="grid grid-cols-3 gap-4">
        {steps.map((step) => (
          <div key={step.id} className={`${step.bgColor} rounded-lg p-4 relative`}>
